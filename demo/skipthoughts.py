...
def load_model():
	...
	with open('uni_skip.npz.pkl', 'rb') as f:
		uoptions = pkl.load(f)
	with open('bi_skip.npz.pkl', 'rb') as f:
		boptions = pkl.load(f)
...
def load_tables():
	...
	words = []
	utable = numpy.load( 'utable.npy',encoding='bytes',allow_pickle=True)
	btable = numpy.load( 'btable.npy',encoding='bytes',allow_pickle=True)
