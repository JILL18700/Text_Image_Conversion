...
#Stage 2 generator
    ...
    def hr_get_generator(self, x_var, c_code):
        if cfg.GAN.NETWORK_TYPE == "default":
            ...
            x_code = self.hr_g_encode_image(x_var) 
    ...
    def get_discriminator(self, x_var, c_var):
        x_code = self.d_image_template.construct(input=x_var)  
    ...
    def hr_d_encode_image(self):
        node1_0 = \
            (pt.template("input"). 
             ...
             conv_batch_norm().
             apply(leaky_rectify, leakiness=0.2).
             custom_conv2d(self.df_dim * 32, k_h=4, k_w=4).  
             conv_batch_norm().
             apply(leaky_rectify, leakiness=0.2).
             custom_conv2d(self.df_dim * 16, k_h=1, k_w=1, d_h=1, d_w=1).  
             conv_batch_norm().
             apply(leaky_rectify, leakiness=0.2).
             custom_conv2d(self.df_dim * 8, k_h=1, k_w=1, d_h=1, d_w=1). 
             conv_batch_norm())
